...
class LoginViewDelegate {
    ...
    func open(twoFactor: Bool, captcha: VKCaptcha.Solved?, completion: @escaping (_: String, _: String, _: String?, _: VKCaptcha.Solved?) -> Void) {
        DispatchQueue.main.async {

            let loginView = LoginView(twoFactor: twoFactor, captcha: captcha, completion: completion)
