        ...
        HStack(alignment: .center, spacing: /*@START_MENU_TOKEN@*/nil/*@END_MENU_TOKEN@*/, content: {
            ...
            .alert(isPresented: $showingAlert1, content: {
                Alert(title: Text("Are you sure you want to transfer all tracks?"),
                      message: Text("All your tracks from \(self.model.facades[self.selectionTo].apiName) "
                      + "would be added to \(self.model.facades[self.selectionFrom].apiName)."),
            ...
            .alert(isPresented: $showingAlert2, content: {
                Alert(title: Text("Are you sure you want to synchronise all tracks?"),
                      message: Text("All your tracks from \(self.model.facades[self.selectionTo].apiName) "
                      + "would be added to \(self.model.facades[self.selectionFrom].apiName), if they are not added yet."),
